...
describe('Global Page', () => {
  ...
  it('should display a Login button', () => {
    assert.eventually.ok(page.connexionButtonElement.isDisplayed(), 'Login button should be displayed');
  });
  ...
  it('should switch url on All videos item menu click', () => {
    ...
    assert.eventually.equal(page.getActiveItemText(), 'TOUTES LES VIDÉOS', 'Inkbar should be on All videos item menu ');
  });
  ...
  it('should switch url home item menu click', () => {
    ...
    assert.eventually.equal(page.getActiveItemText(), 'ACCUEIL', 'Inkbar should be on Home item menu');
  });
